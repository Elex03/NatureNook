...
class ShaderProgram:
    ...
    def get_program(self, shader_program_name):
        with open(f'finished/Main/resources/shaders/{shader_program_name}.vert') as file:
            vertex_shader = file.read()

        with open(f'finished/Main/resources/shaders/{shader_program_name}.frag') as file:
